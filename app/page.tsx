...
export default function FileUploadForm() {
  ...
  return (
    <>
      <div className="sticky top-0 bg-white flex items-center justify-center border-black border-b-2 py-2 px-4">
        <label
          htmlFor="backendInput"
          className="block text-lg font-medium text-gray-700 pr-4"
        >
          Set backend URL:
        </label>
        <input
